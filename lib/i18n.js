...
export const languages = {
  // label: the short code shown in the compact FA | DE header toggle.
  // name: the full language name, still used for the button's title/aria text.
  fa: { name: 'فارسی', dir: 'rtl', label: 'FA', flag: 'فارسی' },
  de: { name: 'Deutsch', dir: 'ltr', label: 'DE', flag: 'Deutsch' },
};
...
export const translations = {
  ...
  'home.page_title': {
    fa: 'دیدار اشتوتگارت – انجمن فرهنگی هنری دیدار',
    de: 'Didar Stuttgart – Iranische Kulturgemeinschaft',
  },
  'home.subtitle': { fa: 'انجمن فرهنگی هنری دیدار — فرهنگ و هنر ایران در اشتوتگارت',
  ...
  'home.about_text': { fa: 'دیدار یک انجمن فرهنگی هنری است که به ارتقای تبادل فرهنگی و هنری ایرانی در شتوتگارت اختصاص دارد.',
                        de: 'Didar ist eine kulturelle Vereinigung, die dem Austausch iranischer Kultur und Kunst in Stuttgart gewidmet ist.' },
  'home.membership_section': { fa: 'عضو دیدار شوید', de: 'Mitglied werden' },
  ...
  'event.registration_closed_message': { fa: 'ثبت‌نام برای این رویداد بسته شده است.', de: 'Die Anmeldung für diese Veranstaltung ist geschlossen.' },
  ...
  'event.weekly_schedule_note': {
    fa: 'این یک نشست هفتگی است؛ تاریخ نمایش‌داده‌شده مربوط به اولین جلسه است و جلسات بعدی هر یکشنبه در همین ساعت برگزار می‌شوند.',
    de: 'Dies ist ein wöchentliches Treffen; das angezeigte Datum bezieht sich auf die erste Sitzung, weitere Sitzungen finden jeden Sonntag zur gleichen Uhrzeit statt.',
  },
  'event.telegram_note': {
    fa: 'برای اطلاعات بیشتر به کانال تلگرام دیدار بپیوندید.',
    de: 'Für weitere Informationen tritt unserem Telegram-Kanal bei.',
  },

  /* About */
  'about.title': { fa: 'درباره دیدار', de: 'Über Didar' },
  'about.intro': { fa: 'دیدار — انجمن فرهنگی هنری دیدار',
                   de: 'Didar — Iranische Kulturgemeinschaft Stuttgart – Hochschulgruppe' },
  'about.mission': { fa: 'ماموریت', de: 'Unsere Mission' },
  'about.mission_text': { fa: 'دیدار متعهد است فرهنگ، هنر و گفتگوی بین‌فرهنگی ایرانی را در اشتوتگارت و فراتر از آن ارتقا دهد.',
  ...
  'membership.intro': { fa: 'عضویت در دیدار', de: 'Mitgliedschaft bei Didar' },
  ...
  'footer.impressum': { fa: 'اطلاعات حقوقی', de: 'Impressum' },
  'footer.datenschutz': { fa: 'سیاست حریم خصوصی', de: 'Datenschutz' },
  'footer.copyright': { fa: '© {{year}} دیدار. تمام حقوق محفوظ است.',

  /* Registration Verification */
  'registration.success': { fa: 'ثبت‌نام تأیید شد!', de: 'Anmeldung bestätigt!' },
  'registration.verify_message': { fa: 'ثبت‌نام شما با موفقیت تأیید شد. شما یک ایمیل تأیید نهایی دریافت خواهید کرد.', de: 'Ihre Anmeldung wurde erfolgreich bestätigt. Sie erhalten eine Bestätigungsmail.' },
  'registration.verification_sent': { fa: 'ثبت‌نام شما ارسال شد. لطفاً برای تأیید، ایمیل خود را بررسی کنید.', de: 'Ihre Anmeldung wurde eingereicht. Bitte überprüfen Sie Ihre E-Mail, um sie zu bestätigen.' },
  'registration.error_already_verified': { fa: 'این ثبت‌نام قبلاً تأیید شده‌است.', de: 'Diese Anmeldung wurde bereits bestätigt.' },
  'registration.error_invalid_token': { fa: 'لینک تأیید نامعتبر یا منقضی است. لطفاً دوباره ثبت‌نام کنید.', de: 'Der Bestätigungslink ist ungültig oder abgelaufen. Bitte registrieren Sie sich erneut.' },
  'registration.error_not_found': { fa: 'ثبت‌نام پیدا نشد.', de: 'Anmeldung nicht gefunden.' },
  'registration.capacity_full': { fa: '⚠️ این رویداد اکنون پر است. شما تأیید شده‌اید اما نام‌نویسی بسته شده‌است.', de: '⚠️ Diese Veranstaltung ist jetzt voll. Sie wurden bestätigt, die Anmeldung ist aber geschlossen.' },
  'registration.verification_loading': { fa: 'درحال تأیید...', de: 'Bestätigung läuft...' },
  'registration.verification_loading_message': { fa: 'لطفاً صبر کنید تا ثبت‌نام شما تأیید شود.', de: 'Bitte warten Sie, während Ihre Anmeldung bestätigt wird.' },
  'registration.verification_error': { fa: 'خطا در تأیید', de: 'Bestätigungsfehler' },
  'registration.back_to_events': { fa: 'بازگشت به رویدادها', de: 'Zurück zu Veranstaltungen' },
                        de: '© {{year}} Didar. Alle Rechte vorbehalten.' },

  /* Legal */
  'legal.impressum': { fa: 'اطلاعات حقوقی', de: 'Impressum' },
...
export function formatDate(date, lang) {
  ...
  if (lang === 'fa') {
    // Persian-language date format, but on the Gregorian (Miladi) calendar —
    // NOT the Persian/Shamsi (Solar Hijri) calendar. The 'fa-IR' locale on
    // its own defaults Intl.DateTimeFormat to the Shamsi calendar, so
    // calendar: 'gregory' is required to keep dates in Gregorian while still
    // showing Persian month/weekday names and numerals.
    ...
    const options = { year: 'numeric', month: 'long', day: 'numeric', timeZone: 'UTC', calendar: 'gregory' };
    return new Intl.DateTimeFormat('fa-IR', options).format(d);
  }
  // German date format (Gregorian, as with all de-DE dates)
...
export function formatTime(timeString, lang) {
  ...
  // 24-hour format for German (e.g. "19:15 Uhr") — German conventionally
  // uses the 24-hour clock, and a 12-hour display with no AM/PM marker
  // is ambiguous (19:15 and 7:15 would render identically).
  return `${hour}:${min.toString().padStart(2, '0')} Uhr`;
}
